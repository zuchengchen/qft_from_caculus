...
% QFTFIGURE-BEGIN ch045globalsymmetriesandnoethercurrents-01-symmetry-flow
\qftfigure{figures/instructional/ch045globalsymmetriesandnoethercurrents/ch045globalsymmetriesandnoethercurrents-01-symmetry-flow.pdf}{The arrows along a level set show a continuous symmetry moving configurations without changing the action.}{fig:ch045globalsymmetriesandnoethercurrents-01-symmetry-flow}
% QFTFIGURE-END ch045globalsymmetriesandnoethercurrents-01-symmetry-flow
...
% QFTFIGURE-BEGIN ch045globalsymmetriesandnoethercurrents-02-current-lines
\qftfigure{figures/instructional/ch045globalsymmetriesandnoethercurrents/ch045globalsymmetriesandnoethercurrents-02-current-lines.pdf}{The streamlines through a region visualize a conserved current as something whose inflow and outflow balance.}{fig:ch045globalsymmetriesandnoethercurrents-02-current-lines}
% QFTFIGURE-END ch045globalsymmetriesandnoethercurrents-02-current-lines
...
% QFTFIGURE-BEGIN ch045globalsymmetriesandnoethercurrents-03-charge-region
\qftfigure{figures/instructional/ch045globalsymmetriesandnoethercurrents/ch045globalsymmetriesandnoethercurrents-03-charge-region.pdf}{The shaded region with boundary flux connects a conserved charge to a local continuity equation.}{fig:ch045globalsymmetriesandnoethercurrents-03-charge-region}
% QFTFIGURE-END ch045globalsymmetriesandnoethercurrents-03-charge-region
...
% QFTFIGURE-BEGIN ch045globalsymmetriesandnoethercurrents-04-stress-energy
\qftfigure{figures/instructional/ch045globalsymmetriesandnoethercurrents/ch045globalsymmetriesandnoethercurrents-04-stress-energy.pdf}{The grid of arrows indicates that energy and momentum move through spacetime as local fluxes.}{fig:ch045globalsymmetriesandnoethercurrents-04-stress-energy}
% QFTFIGURE-END ch045globalsymmetriesandnoethercurrents-04-stress-energy
