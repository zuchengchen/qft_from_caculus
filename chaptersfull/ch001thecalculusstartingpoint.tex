...
% QFTFIGURE-BEGIN ch001thecalculusstartingpoint-01-linear-approx
\qftfigure{figures/instructional/ch001thecalculusstartingpoint/ch001thecalculusstartingpoint-01-linear-approx.pdf}{The tangent picture shows how a small neighborhood turns a curved function into the first-order data that later becomes a local field equation.}{fig:ch001thecalculusstartingpoint-01-linear-approx}
% QFTFIGURE-END ch001thecalculusstartingpoint-01-linear-approx
...
% QFTFIGURE-BEGIN ch001thecalculusstartingpoint-02-riemann-sum
\qftfigure{figures/instructional/ch001thecalculusstartingpoint/ch001thecalculusstartingpoint-02-riemann-sum.pdf}{The rectangles emphasize that an integral is a controlled limit of finite bookkeeping, the same bookkeeping used before functional integrals are introduced.}{fig:ch001thecalculusstartingpoint-02-riemann-sum}
% QFTFIGURE-END ch001thecalculusstartingpoint-02-riemann-sum
...
% QFTFIGURE-BEGIN ch001thecalculusstartingpoint-03-integration-parts
\qftfigure{figures/instructional/ch001thecalculusstartingpoint/ch001thecalculusstartingpoint-03-integration-parts.pdf}{The shaded edge pieces remind the reader that integration by parts moves a derivative only after the boundary contribution has been named.}{fig:ch001thecalculusstartingpoint-03-integration-parts}
% QFTFIGURE-END ch001thecalculusstartingpoint-03-integration-parts
...
% QFTFIGURE-BEGIN ch001thecalculusstartingpoint-04-error-scale
\qftfigure{figures/instructional/ch001thecalculusstartingpoint/ch001thecalculusstartingpoint-04-error-scale.pdf}{The nested neighborhoods show why an approximation must say which terms shrink fastest as the scale of the calculation is reduced.}{fig:ch001thecalculusstartingpoint-04-error-scale}
% QFTFIGURE-END ch001thecalculusstartingpoint-04-error-scale
