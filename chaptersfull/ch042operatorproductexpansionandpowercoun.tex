...
% QFTFIGURE-BEGIN ch042operatorproductexpansionandpowercoun-01-short-distance
\qftfigure{figures/instructional/ch042operatorproductexpansionandpowercoun/ch042operatorproductexpansionandpowercoun-01-short-distance.pdf}{The two nearby insertions merging into one local region make the operator product expansion visible.}{fig:ch042operatorproductexpansionandpowercoun-01-short-distance}
% QFTFIGURE-END ch042operatorproductexpansionandpowercoun-01-short-distance
...
% QFTFIGURE-BEGIN ch042operatorproductexpansionandpowercoun-02-local-operators
\qftfigure{figures/instructional/ch042operatorproductexpansionandpowercoun/ch042operatorproductexpansionandpowercoun-02-local-operators.pdf}{The stacked local terms show the OPE as an ordered expansion in increasingly suppressed operators.}{fig:ch042operatorproductexpansionandpowercoun-02-local-operators}
% QFTFIGURE-END ch042operatorproductexpansionandpowercoun-02-local-operators
...
% QFTFIGURE-BEGIN ch042operatorproductexpansionandpowercoun-03-power-counting
\qftfigure{figures/instructional/ch042operatorproductexpansionandpowercoun/ch042operatorproductexpansionandpowercoun-03-power-counting.pdf}{The shrinking bars show how operator dimension organizes the importance of terms.}{fig:ch042operatorproductexpansionandpowercoun-03-power-counting}
% QFTFIGURE-END ch042operatorproductexpansionandpowercoun-03-power-counting
...
% QFTFIGURE-BEGIN ch042operatorproductexpansionandpowercoun-04-coefficient-functions
\qftfigure{figures/instructional/ch042operatorproductexpansionandpowercoun/ch042operatorproductexpansionandpowercoun-04-coefficient-functions.pdf}{The smooth outer envelopes around a local insertion show long-distance coefficients multiplying local data.}{fig:ch042operatorproductexpansionandpowercoun-04-coefficient-functions}
% QFTFIGURE-END ch042operatorproductexpansionandpowercoun-04-coefficient-functions
