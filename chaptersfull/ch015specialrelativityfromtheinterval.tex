...
% QFTFIGURE-BEGIN ch015specialrelativityfromtheinterval-01-light-cone
\qftfigure{figures/instructional/ch015specialrelativityfromtheinterval/ch015specialrelativityfromtheinterval-01-light-cone.pdf}{The cone separates timelike, lightlike, and spacelike directions before any relativistic formula is used.}{fig:ch015specialrelativityfromtheinterval-01-light-cone}
% QFTFIGURE-END ch015specialrelativityfromtheinterval-01-light-cone
...
% QFTFIGURE-BEGIN ch015specialrelativityfromtheinterval-02-boost
\qftfigure{figures/instructional/ch015specialrelativityfromtheinterval/ch015specialrelativityfromtheinterval-02-boost.pdf}{The tilted axes show a boost as a change of spacetime coordinates that leaves the interval structure intact.}{fig:ch015specialrelativityfromtheinterval-02-boost}
% QFTFIGURE-END ch015specialrelativityfromtheinterval-02-boost
...
% QFTFIGURE-BEGIN ch015specialrelativityfromtheinterval-03-mass-shell
\qftfigure{figures/instructional/ch015specialrelativityfromtheinterval/ch015specialrelativityfromtheinterval-03-mass-shell.pdf}{The hyperbola visualizes the invariant relation between energy, momentum, and mass while separating the two physical branches.}{fig:ch015specialrelativityfromtheinterval-03-mass-shell}
% QFTFIGURE-END ch015specialrelativityfromtheinterval-03-mass-shell
...
% QFTFIGURE-BEGIN ch015specialrelativityfromtheinterval-04-four-vector
\qftfigure{figures/instructional/ch015specialrelativityfromtheinterval/ch015specialrelativityfromtheinterval-04-four-vector.pdf}{The arrow in spacetime with projected components separates the geometric vector from its frame-dependent coordinates.}{fig:ch015specialrelativityfromtheinterval-04-four-vector}
% QFTFIGURE-END ch015specialrelativityfromtheinterval-04-four-vector
...
% QFTFIGURE-BEGIN ch015specialrelativityfromtheinterval-05-index-raising
\qftfigure{figures/instructional/ch015specialrelativityfromtheinterval/ch015specialrelativityfromtheinterval-05-index-raising.pdf}{The paired grids show the metric as the object that translates between related component descriptions.}{fig:ch015specialrelativityfromtheinterval-05-index-raising}
% QFTFIGURE-END ch015specialrelativityfromtheinterval-05-index-raising
...
% QFTFIGURE-BEGIN ch015specialrelativityfromtheinterval-06-causal-diamond
\qftfigure{figures/instructional/ch015specialrelativityfromtheinterval/ch015specialrelativityfromtheinterval-06-causal-diamond.pdf}{The diamond region makes clear which events can influence or be influenced by a given interval.}{fig:ch015specialrelativityfromtheinterval-06-causal-diamond}
% QFTFIGURE-END ch015specialrelativityfromtheinterval-06-causal-diamond
