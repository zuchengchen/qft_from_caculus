...
% QFTFIGURE-BEGIN ch010lagrangianmechanics-01-configuration-path
\qftfigure{figures/instructional/ch010lagrangianmechanics/ch010lagrangianmechanics-01-configuration-path.pdf}{The curve through configuration space shows mechanics as a problem of comparing entire histories, not isolated positions.}{fig:ch010lagrangianmechanics-01-configuration-path}
% QFTFIGURE-END ch010lagrangianmechanics-01-configuration-path
...
% QFTFIGURE-BEGIN ch010lagrangianmechanics-02-action-landscape
\qftfigure{figures/instructional/ch010lagrangianmechanics/ch010lagrangianmechanics-02-action-landscape.pdf}{The valley picture separates stationary action from a naive force diagram and prepares the variational derivation.}{fig:ch010lagrangianmechanics-02-action-landscape}
% QFTFIGURE-END ch010lagrangianmechanics-02-action-landscape
...
% QFTFIGURE-BEGIN ch010lagrangianmechanics-03-generalized-coordinate
\qftfigure{figures/instructional/ch010lagrangianmechanics/ch010lagrangianmechanics-03-generalized-coordinate.pdf}{The curved coordinate grid shows why coordinates can be chosen for the problem rather than inherited from a fixed room.}{fig:ch010lagrangianmechanics-03-generalized-coordinate}
% QFTFIGURE-END ch010lagrangianmechanics-03-generalized-coordinate
...
% QFTFIGURE-BEGIN ch010lagrangianmechanics-04-constraint
\qftfigure{figures/instructional/ch010lagrangianmechanics/ch010lagrangianmechanics-04-constraint.pdf}{The path confined to a surface shows how constraints reduce the space of allowed motions.}{fig:ch010lagrangianmechanics-04-constraint}
% QFTFIGURE-END ch010lagrangianmechanics-04-constraint
