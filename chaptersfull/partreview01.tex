...
% QFTFIGURE-BEGIN partreview01-01-part-map
\qftfigure{figures/instructional/partreview01/partreview01-01-part-map.pdf}{The map collects the part's main constructions into a visual route so the reader can see how the chapters support one another.}{fig:partreview01-01-part-map}
% QFTFIGURE-END partreview01-01-part-map
