...
\begin{document}
\begin{tikzpicture}
  \node[anchor=south west, inner sep=0] (img) at (0,0) {\includegraphics[width=12cm]{ch039runningcouplingsandtherenormalizatio-02-beta-vector-field.png}};
  \begin{scope}[
    x={(img.south east)},
    y={(img.north west)},
    ...
    \node[labelbox, anchor=north west] at (0.035,0.965) {beta function flow};
